...
function init_gear_sets()
  ...
  sets.midcast['Dummy'] = {
    range={name='Terpander',priority = 16},
  ...
  sets.idle = {
    ...
    back="Moonbeam Cape",waist="Fucho-no-Obi",legs="Assiduity Pants +1",feet="Fili Cothurnes"}
  ...
  sets.idle.Weak = {
    ...
    back="Moonbow Cape",waist="Chaac Belt",legs="Inyanga Shalwar +2",feet="Fili Cothurnes"}
