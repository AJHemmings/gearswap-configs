...
function get_sets()
	...
	-- Ammo Selection need Forma to get Chrono
	Ammo.Bullet.RA = "Titanium Bullet" --"Chrono Bullet"		-- TP Ammo
	Ammo.Bullet.WS = "Titanium Bullet"--"Chrono Bullet"		-- Physical Weaponskills
	Ammo.Bullet.CRIT = "Titanium Bullet"--"Chrono Bullet"		-- Critical Hit Mode
	Ammo.Bullet.PDL = "Titanium Bullet"--"Chrono Bullet"		-- Physical Damage Mode
	Ammo.Bullet.SB = "Titanium Bullet"--"Chrono Bullet"		-- Subtle Blow Mode
	Ammo.Bullet.MAB = "Living Bullet"		-- Magical Weaponskills
	Ammo.Bullet.MACC = "Titanium Bullet"--"Chrono Bullet"		-- Magic Accuracy
	...
	sets.Precast.RA = {
		...
		neck={ name="Comm. Charm +1", augments={'Path: A',}}, -- 4/0
