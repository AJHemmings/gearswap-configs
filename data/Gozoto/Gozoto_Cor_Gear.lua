...
function user_job_setup()
	...
	state.Weapons:options('Default', 'Lvl1','DualSavageWeapons','DualLeadenRanged','DualLeadenMelee','DualWeapons','DynaRP')--,'DualSavageWeapons','DualLeadenRanged','DualLeadenMelee','DualAeolian','DualLeadenMeleeAcc','DualRanged','None')
	state.CompensatorMode:options('Always','300','1000','Never')

    gear.RAbullet = "Divine Bullet" --Chrono Bullet"
    gear.WSbullet = "Titanium Bullet"--"Chrono Bullet"
...
function init_gear_sets()
    ...
    sets.precast.CorsairShot = {
        ammo=gear.QDbullet,
        head={ name="Herculean Helm", augments={'Mag. Acc.+20 "Mag.Atk.Bns."+20','Magic burst dmg.+1%','"Mag.Atk.Bns."+12',}},
        body={ name="Herculean Vest", augments={'MND+8','Pet: Attack+15 Pet: Rng.Atk.+15','Weapon skill damage +8%','Mag. Acc.+13 "Mag.Atk.Bns."+13',}},
        hands="Mummu Wrists +2",
        legs="Mummu Kecks +2",
        feet={ name="Herculean Boots", augments={'Enmity-3','"Mag.Atk.Bns."+17','Mag. Acc.+12 "Mag.Atk.Bns."+12',}},
        neck="Marked Gorget",
        waist="Eschan Stone",
    ...
    sets.midcast.RA = {
        ammo=gear.RAbullet,
        head={ name="Herculean Helm", augments={'Mag. Acc.+2','MND+7','"Treasure Hunter"+2',}},
        body={ name="Herculean Vest", augments={'Accuracy+17','DEX+10','"Treasure Hunter"+2','Accuracy+14 Attack+14',}},
        neck="Marked Gorget",
    ...
    sets.weapons.Lvl1 = {main="Aern Dagger II",sub="Warp Cudgel",range="Death Penalty"}    
	sets.weapons.DualWeapons = {main="Naegling",sub="Blurred Knife +1",range="Death Penalty"} --fORMA
	sets.weapons.DualSavageWeapons = {main="Naegling",sub="Blurred Knife +1",range="Anarchy +2"}
	sets.weapons.DualLeadenRanged = {main="Naegling",main={ name="Rostam", augments={'Path: A',}},range="Death Penalty"}
	sets.weapons.DualLeadenMelee = {main="Naegling",sub="Blurred Knife +1",range="Death Penalty"}
    sets.weapons.DynaRP = {main={ name="Rostam", augments={'Path: A',}},sub={ name="Rostam", augments={'Path: C',}}, neck="Commodore Charm +1"}
