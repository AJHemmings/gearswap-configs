...
function init_gear_sets()
	...
	sets.midcast.Pet.PetWSGear = {
        ...
        body={ name="Taeon Tabard", augments={'Pet: Attack+25 Pet: Rng.Atk.+25','Pet: "Dbl. Atk."+3','Pet: Damage taken -3%',}},
        hands={ name="Taeon Gloves", augments={'Pet: Accuracy+18 Pet: Rng. Acc.+18','Pet: "Dbl. Atk."+3','Pet: Damage taken -4%',}},
        ...
        back={ name="Dispersal Mantle", augments={'STR+2','DEX+1','Pet: TP Bonus+460',}},
    }
