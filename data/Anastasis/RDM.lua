...
function get_sets()
    ...
    back={ name="Sucellos's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','MND+10','Occ. inc. resist. to stat. ailments+10',}},
		-- ammo="Staunch Tathlum +1", -- 3/3
		-- head={ name="Viti. Chapeau +1", augments={'Enfeebling Magic duration','Magic Accuracy'}, priority=3}, -- +3 Refresh
    ...
    back={ name="Sucellos's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','MND+10','Occ. inc. resist. to stat. ailments+10',}},
		...
		-- head="Bunzi's Hat", -- 10
		-- body={ name="Viti. Tabard +1", augments={'Enhances "Chainspell" effect',}}, -- 15
	...
	sets.Midcast.SIRD = {
		...
		right_ring="Murky Ring",
		legs="Carmine Cuisses +1",
		back={ name="Sucellos's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','"Mag.Atk.Bns."+10','Spell interruption rate down-10%',}},
	...
	sets.Midcast.Enfeebling.Potency = set_combine(sets.Midcast.Enfeebling, {
		...
		body="Lethargy Sayon +3", -- 14%
   		back={ name="Sucellos's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','MND+10','Occ. inc. resist. to stat. ailments+10',}},
		feet={ name="Vitiation Boots +2", augments={'Immunobreak Chance',}}, -- 10%
		neck="Dls. Torque +2",
	})
	...
	sets.Midcast.Enfeebling.Duration = set_combine(sets.Midcast.Enfeebling, {
		head={ name="Viti. Chapeau +1", augments={'Enfeebling Magic duration','Magic Accuracy',}}, -- 15s (3 seconds x 5 merits)
