...
--Weapons options
state.WeaponMode:options('Chango','Shining One','Savage Blade','Decimation', 'Aeolian Edge', 'Club', 'Ukonvasara','Unlocked')
...
function get_sets()
	...
	sets.Precast['Utsusemi: Ichi'] = set_combine(sets.FastCast, {})
	sets.Precast['Utsusemi: Ni'] = set_combine(sets.FastCast, {})
	...
	sets.JA["Berserk"] = { back= "Cichol's Mantle", body = 'Pumm. Lorica +4', feet = 'Agoge Calligae +1' }
