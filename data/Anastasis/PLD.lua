...
state.WeaponMode:options('Burtgang','Naegling','Club','Shining One', 'Ochain', 'NaegDPS', 'Srivatsa', 'Aegis') -- Weapons used for tanking and DPS
...
function get_sets()
    ...
    -- back={ name="Rudianos's Mantle", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Enmity+10','Damage taken-5%',}},
		ammo="Staunch Tathlum +1", -- D3
		--ammo="Homiliary",
		head="Chev. Armet +2", -- D10
		body={ name="Sakpata's Plate", augments={'Path: A',}}, -- D10
		hands={ name="Sakpata's Gauntlets", augments={'Path: A',}}, -- D8
		legs="Chev. Cuisses +3", -- D13
		feet="Sakpata's Leggings", -- D6
		neck={ name="Unmoving Collar +1", augments={'Path: A',}, priority=1},
		waist="Plat. Mog. Belt", --D3
		left_ear={ name="Odnowa Earring +1", augments={'Path: A',}}, -- MD2
		right_ear="Alabaster Earring", --D5
		--right_ear="Tuisto Earring",
		--right_ear="Sanare Earring",
		left_ring ="Moonlight Ring", --D5
		right_ring ="Fortified Ring", --MD5 ECR7
		--left_ring={ name="Moonlight Ring", bag="wardrobe1", priority=2},
		--right_ring={ name="Moonlight Ring", bag="wardrobe2", priority=3},
		back={ name="Rudianos's Mantle", augments={'HP+60','Eva.+20 /Mag. Eva.+20','HP+20','Enmity+10'}, priority=4},
	}
	...
	sets.Midcast.SIRD = {
    	...
    	body={ name="Yorium Cuirass", augments={'Spell interruption rate down -10%',}}, --10
    	hands={ name="Yorium Gauntlets", augments={'Spell interruption rate down -10%',}}, --10
        feet="Odyssean Greaves", --20   |
		neck = "Moonbeam Necklace", -- 10
		left_ear="Knightly Earring", --10
	...
	sets.Midcast.Cure = {		
		...
		ring2 = "Murky Ring", --3
   		back={ name="Rudianos's Mantle", augments={'HP+60','Eva.+20 /Mag. Eva.+20','"Cure" potency +10%',}},
		waist = "Audumbla Sash", --10
		legs = "Founder's Hose", --30
		feet = "Odyssean Greaves", --20
	...
	sets.JA["Shield Bash"] = set_combine( sets.Enmity, { hands={ name="Cab. Gauntlets +4", augments={'Enhances "Chivalry" effect',}} })
	sets.JA["Holy Circle"] = set_combine( sets.Enmity, { })
	sets.JA["Sentinel"] = set_combine( sets.Enmity, { feet={ name="Cab. Leggings", augments={'Enhances "Guardian" effect',}} })
	...
	sets.JA["Iron Will"] = set_combine( sets.Enmity, { head={ name="Cab. Coronet", augments={'Enhances "Iron Will" effect',}} })
	sets.JA["Fealty"] = set_combine( sets.Enmity, { body={ name="Cab. Surcoat", augments={'Enhances "Fealty" effect',}} })
	sets.JA["Chivalry"] = set_combine( sets.Enmity, { hands={ name="Cab. Gauntlets +4", augments={'Enhances "Chivalry" effect',}} })
	...
	sets.WS = {
		...
		back={ name="Rudianos's Mantle", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Weapon skill damage +10%',}},
