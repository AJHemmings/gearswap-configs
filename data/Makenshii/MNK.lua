...
state.OffenseMode:options('TP','ACC','DT','PDL','SB','MEVA','DEF') -- ACC effects WS and TP modes
...
function get_sets()
    ...
    back={ name="Segomo's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+5','"Dbl.Atk."+10','Damage taken-5%',}},
	...
	sets.Idle.DEF = set_combine(sets.Idle, {
	})
    ...
    waist="Moonbow Belt +1",
    left_ear="Sherida Earring",
    right_ear={ name="Bhikku Earring +1", augments={'System: 1 ID: 1676 Val: 0','Accuracy+13','Mag. Acc.+13','"Store TP"+4',}},
