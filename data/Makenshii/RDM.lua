...
--Modes for TP
state.WeaponMode:options('Seraph Blade', 'Sanguine Blade', 'Chant du Cygne','Savage Blade', 'Eviceration', 'Aeolian Edge', 'Black Halo', 'Ullr', 'Unlocked', 'SortieMB', 'Murgleis')
...
function get_sets()
	...
	sets.Midcast.Cure = {
		...
		main="Daybreak", --30
		sub={ name="Genbu's Shield", augments={'"Cure" potency +2%','"Cure" spellcasting time -3%',}}, --2
	...
	sets.Midcast.Enfeebling.Potency = set_combine(sets.Midcast.Enfeebling, {
		ammo="Regal Gem", -- 10%
		body="Lethargy Sayon +2", -- 16%
		back={ name="Sucellos's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','MND+10','Weapon skill damage +10%',}}, -- 10%
		legs={ name="Chironic Hose", augments={'Mag. Acc.+26','"Cure" spellcasting time -11%','MND+7',}},
