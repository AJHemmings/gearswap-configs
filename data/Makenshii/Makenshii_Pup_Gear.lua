...
function init_gear_sets()
    ...
    sets.precast.JA['Repair'] = {ammo="Automat. Oil +3", feet="Foire Babouches +2"} 
    ...
    } --hands="Foire Dastanas",body="Cirque Farsetto +2",
    ...
    sets.precast.WS['Victory Smite'] = {
        ...
        back="Relucent Cape",
    }                                      --set_combine(sets.precast.WS, {body="Abnoba Kaftan"})
    ...
    sets.midcast.Pet.PetWSGear.Ranged = set_combine(sets.midcast.Pet.PetWSGear, {
        ...
        back={ name="Dispersal Mantle", augments={'STR+3','DEX+3','Pet: TP Bonus+500','"Martial Arts"+13',}},
    })
    ...
    sets.idle.Pet.Engaged = {
        main="Xiucoatl",
        head={ name="Herculean Helm", augments={'Pet: "Mag.Atk.Bns."+25','Pet: "Store TP"+9','Pet: AGI+9','Pet: Attack+12 Pet: Rng.Atk.+12',}},
        body={ name="Pitre Tobe +1", augments={'Enhances "Overdrive" effect',}},
        hands={ name="Herculean Gloves", augments={'Pet: "Store TP"+11','Pet: Attack+11 Pet: Rng.Atk.+11',}},
        legs={ name="Herculean Trousers", augments={'Pet: Attack+11 Pet: Rng.Atk.+11','Pet: "Store TP"+9','Pet: STR+7','Pet: "Mag.Atk.Bns."+3',}},
        feet={ name="Herculean Boots", augments={'Pet: Attack+21 Pet: Rng.Atk.+21','Pet: "Store TP"+10',}},
        neck="Shulmanu Collar",
        waist="Klouskap Sash +1",
        left_ear="Burana Earring",
        right_ear={ name="Karagoz Earring", augments={'System: 1 ID: 1676 Val: 0','Accuracy+9','Mag. Acc.+9',}},
        left_ring="Varar Ring",
        right_ring="Fickblix's Ring",
        back={ name="Visucius's Mantle", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Accuracy+20 Attack+20','Pet: Accuracy+5 Pet: Rng. Acc.+5','System: 1 ID: 1246 Val: 4',}},
    }
...
function user_job_lockstyle()
        windower.chat.input('/lockstyleset 10')
    end
end