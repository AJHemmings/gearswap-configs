...
function init_gear_sets()
    ...
    } --neck="Buffoon's Collar",hands="Foire Dastanas",body="Cirque Farsetto +2",
    ...
    sets.idle = {
        range="Animator P II +1",
        head={ name="Taeon Chapeau", augments={'Pet: Attack+11 Pet: Rng.Atk.+11',}},
        body={ name="Taeon Tabard", augments={'Pet: Attack+25 Pet: Rng.Atk.+25',}},
        hands={ name="Taeon Gloves", augments={'Pet: Attack+21 Pet: Rng.Atk.+21',}},
        legs={ name="Taeon Tights", augments={'Pet: Attack+24 Pet: Rng.Atk.+24',}},
	...
	-- Weapons sets
	sets.weapons.PetWeapons = {main="Ohtas",range="Animator P II +1",}
	sets.weapons.Godhands = {main="Godhands",range="Animator P II +1",}
end
