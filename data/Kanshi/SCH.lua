...
function get_sets()
	...
	sets.Idle.Sublimation = set_combine(sets.Idle, {
		head="Arbatel Pants +2", -- +4 Submlimation when active
    ...
    sub="Enki Strap",
    ammo="Incantor Stone",
    head={ name="Merlinic Hood", augments={'"Mag.Atk.Bns."+1','INT+10','Mag. Acc.+20 "Mag.Atk.Bns."+20',}},
    body="Arbatel Gown +2",
    ...
    back="Perimede Cape",
		...
		-- head={ name="Peda. Mortar. +4", augments={'Enh. "Altruism" and "Focalization"',}}, -- 13% Grimoire, 6% Haste
		-- body="Pinga Tunic +1", -- 15% FC, Haste
		-- hands="Acad. Bracers +4", -- 9% FC, 3% Haste
		-- legs="Pinga Pants +1", -- 13% FC, 5% Haste
		-- feet="Acad. Loafers +4", -- 12% Grimoire, 3% Haste
	...
	-- Job Abilities
	sets.JA = {}
	sets.JA["Light Arts"] = {legs="Acad. Pants +4",}
	sets.JA["Penury"] = {legs="Arbatel Pants +2",}
	sets.JA["Celerity"] = {}
	sets.JA["Rapture"] = {head="Arbatel Bonnet +2",}
	sets.JA["Accession"] = {}
	sets.JA["Perpetuance"] = {hands="Arbatel Bracers +2",}
	sets.JA["Addendum: White"] = {body="Arbatel Gown +2",}
	...
	sets.JA["Parsimony"] = {legs="Arbatel Pants +2",}
	sets.JA["Alacrity"] = {}
	sets.JA["Ebullience"] = {head="Arbatel Bonnet +2",}
	sets.JA["Manifestation"] = {}
	sets.JA["Focalization"] = {head="Peda. Mortar. +4",}
	sets.JA["Immanence"] = {hands="Arbatel Bracers +2",}

	sets.JA["Sublimation"] = {
		head="Arbatel Pants +2",
		body="Peda. Gown +3",
		waist="Embla Sash",
		
	}
	sets.JA["Tabula Rasa"] = {legs={ name="Peda. Pants +4", augments={'Enhances "Tabula Rasa" effect',}}}
	...
	sets.Penury = { legs="Arbatel Pants +2", } -- not swapped due to duration
