...
state.OffenseMode:options('TP','ACC','DT','PDT','MEVA','Refresh')
...
function get_sets()
    ...
    hands={ name="Chironic Gloves", augments={'INT+1','DEX+8','"Refresh"+2',}}, -- refresh 2
    legs="Bunzi's Pants", -- DT 9
    feet={ name="Nyame Sollerets", augments={'Path: B',}}, -- DT 7
    neck="Elite Royal Collar", -- DT 5
    ...
    back={ name="Alaunus's Cape", augments={'MND+20','"Fast Cast"+10','Damage taken-5%',}}, -- DT 5
	})
    ...
    hands={ name="Chironic Gloves", augments={'INT+1','DEX+8','"Refresh"+2',}},
    legs="Bunzi's Pants",
    feet={ name="Chironic Slippers", augments={'Crit.hit rate+1','Damage taken-2%','"Refresh"+2','Accuracy+1 Attack+1','Mag. Acc.+18 "Mag.Atk.Bns."+18',}},
    neck="Elite Royal Collar",
    waist="Plat. Mog. Belt",
    ...
    left_ring="Stikini Ring +1",
    right_ring="Stikini Ring +1",
    back={ name="Alaunus's Cape", augments={'MND+20','"Fast Cast"+10','Damage taken-5%',}},
	})
	...
	sets.Midcast.Cura = set_combine(sets.Midcast.Cure, {body="Theo. Bliaut +4",})
	...
	sets.Midcast.Enfeebling = { --398 MACC
    main="Bunzi's Rod",
    sub="Ammurapi Shield",
    ammo="Hydrocera",
    head="Ebers Cap +2",
	...
	sets.Midcast.Dark.MACC = set_combine(sets.Midcast.Enfeebling, {
	...
	sets.Midcast.Enfeebling.Potency = sets.Midcast.Enfeebling
