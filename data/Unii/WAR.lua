...
--Weapons options
state.WeaponMode:options('Savage Blade','Shining One','Club','Unlocked')
...
function get_sets()
	...
	sets.Idle = {
		...
		back={ name="Cichol's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10','DEX+10','Damage taken-5%',}},
    }
	...
	sets.OffenseMode = {
		...
		right_ear="Boii Earring", -- 8 DA
		left_ring="Petrov Ring",
		right_ring="Niqmaddu Ring",
		back={ name="Cichol's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10','DEX+10','Damage taken-5%',}}, -- 10 DA
	}
	...
	--These base set are used when an aftermath is active and player is engaged and correct weapon type set (Augments the current OffenseMode)
	...
	sets.JA["Warcry"] = {head={ name="Agoge Mask +4", augments={'Enhances "Savagery" effect',}}}
	sets.JA["Defender"] = {}
	sets.JA["Aggressor"] = {}
