...
function get_sets()
    ...
    sub="Ammurapi Shield",
    range="Dunna",
    head="Geo. Galero +4", --57
    body="Geomancy Tunic +4", --60
    hands="Geo. Mitaines +4", --58
    legs="Geomancy Pants +4", --49
    feet="Geo. Sandals +4", --46 + set 60
    neck={ name="Bagua Charm +2", augments={'Path: A',}},
    waist="Famine Sash",
    ...
    left_ring="Medada's Ring",
    right_ring="Stikini Ring +1",
    back={ name="Nantosuelta's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+5',}},
	}
	...
	sets.Geomancy.Indi = {
		...
		body="Azimuth Coat +3",
		hands="Geo. Mitaines +4",
		legs={ name="Bagua Pants +1", augments={'Enhances "Mending Halation" effect',}}, -- 21
		feet="Azimuth Gaiters", -- 30
		neck={ name="Bagua Charm +2", augments={'Path: A',}},
		waist="Luminary Sash",
		left_ear={ name="Odnowa Earring +1", augments={'Path: A',}},
		right_ear="Etiolation Earring",
...
function Luopan() --  This maintains the extra 600hp during midcast of spells when Luopan is deployed
	...
	-- Swap the right head
	if pet.isvalid then
		equipSet = sets.Idle.Pet
		if relic_equiped then
			if pet.hpp > 68 then
