...
bpmagicaccstaff={ name="Grioavolr", augments={'Blood Pact Dmg.+7','Pet: VIT+2','Pet: Mag. Acc.+25','Pet: "Mag.Atk.Bns."+13','DMG:+4',}}
smnskillstaff = { name="Espiritus", augments={'Summoning magic skill +15','Pet: Mag. Acc.+30','Pet: Damage taken -4%',}}
...
sets.petmab = { 
    ...
    hands={ name="Merlinic Dastanas", augments={'Blood Pact Dmg.+9','Pet: INT+7','Pet: Mag. Acc.+3','Pet: "Mag.Atk.Bns."+10',}},
    legs={ name="Merlinic Shalwar", augments={'Pet: "Mag.Atk.Bns."+23','Blood Pact Dmg.+5','Pet: STR+9',}},
...
sets.midcast.Pet.HybridBloodPactRage = { --At this time is only your flaming crush set
    ...
    body={ name="Apo. Dalmatica +1", augments={'Pet: Attack+25','Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+8',}},
    hands={ name="Apogee Mitts +1", augments={'MP+80','Pet: Attack+35','Blood Pact Dmg.+8',}},
    legs={ name="Apogee Slacks", augments={'MP+60','Pet: Attack+30','Blood Pact Dmg.+7',}},
    feet={ name="Apogee Pumps", augments={'Pet: Attack+20','Pet: "Mag.Atk.Bns."+20','Blood Pact Dmg.+7',}},
    neck="Adad Amulet",
    waist="Incarnation Sash",
    left_ear="Esper Earring",
...
--    }
sets.perp.Carbuncle = set_combine(sets.perp, {hands="Asteria Mitts"})
